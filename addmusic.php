<?php
    ...
    if( isset($_POST["submit"]) ) {
        ...
        if( addmusic($_POST) > 0 ) {
            echo "<script>
                    alert('Musik berhasil di tambahkan !');
                    document.location.href = 'dashboard.php';
            </script>";
        } else {
            echo "<script>
            alert('Musik gagal di tambahkan !');
    </script>";
        }
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="file_music" class="form-label">Musik</label>
                                    <input type="file" class="form-control" id="file_music" aria-describedby="file_music" name="file_music[]" multiple>
                                </div>
